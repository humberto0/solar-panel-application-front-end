...
import ModelsContext, { infSolar } from '../ModelsContext';
...
const ModelsWrapper: React.FC = ({ children }) => {
  ...
  const [registeredModels, setRegisteredModels] = useState<infSolar[]>([]);

  const registerModel = useCallback((model: infSolar) => {
